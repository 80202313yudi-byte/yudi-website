...
- 2026-08-17: Added the user-selected matched 3D portrait pair as
  ...
  supplied no-wave portrait and the second adds a five-finger wave with a
  natural teeth-showing smile while preserving the warm studio composition.
  The pair remains inactive and was not published.
