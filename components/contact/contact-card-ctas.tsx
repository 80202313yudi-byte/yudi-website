...
export function ContactCardCtas(): ReactNode {
  ...
  if (prefersReducedMotion) {
    return (
      <div className="mt-2 flex flex-row flex-nowrap items-center justify-center gap-3 sm:flex-wrap sm:justify-start">
        <ContactButton />
        <div>{projectLink}</div>
      </div>
    );
  ...
  return (
    <LayoutGroup>
      <motion.div
        ...
        className="mt-2 flex flex-row flex-nowrap items-center justify-center gap-3 sm:flex-wrap sm:justify-start"
      >
        <ContactButton />
